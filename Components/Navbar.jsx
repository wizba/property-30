"use client"; // when you want to use hooks
      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            {!session && (
                providers && Object.values(providers).map((provider,index) => (<button className="flex items-center text-white bg-gray-700 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 my-4">
                <FaGoogle className="text-white mr-2" />
                <span>Login or Register</span>
              </button>))
            )}

...
const PropertyDetails = ({property}) => {
  return (   <main>
    ...
    >
      <div className="text-gray-500 mb-4">{property.name}</div>
    ...
    <div className="bg-white p-6 rounded-lg shadow-md mt-6">
      ...
      <p className="text-gray-500 mb-4">
        We have a beautiful {property.type} located near the commons. It is a{" "}
        {property.beds} bedroom apartment with a full kitchen and bathroom. It is
